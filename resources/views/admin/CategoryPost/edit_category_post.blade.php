                    ...
                    <form role="form" action="{{URL::to('/update-category-post/'.$category_post->category_post_id)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category_post_name" class="form-control" id="slug"
                                placeholder="Enter email" onkeyup="ChangeToSlug();" value="{{$category_post->category_post_name}}">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="edit_category_post" class="btn btn-info">Cập nhật danh mục bài viết</button>
                    </form>
